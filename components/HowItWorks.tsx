...
const howItWorksItems = [
  {
    ...
    description:
      "Our drones autonomously patrol the target areas, using an array of sensors to monitor critical environmental factors and sending sensor data in real-time to command centers.",
  ...
  },
  {
    ...
    description:
      "Advanced analytics process incoming data, providing clear visual maps and alerts to help teams make informed decisions.",
...
export default function HowItWorksSection() {
  return (
    <section className="px-6 md:px-28 bg-white text-black">
      <h2 className="text-3xl md:text-5xl font-bold text-orange-500 mb-24 text-center">How It Works</h2>
